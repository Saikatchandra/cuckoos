<template>
    <div>
        <article class="card">
            <header class="card-header"> My Refunds </header>
            <div class="card-body">
        <h6>Order ID: 09876545678</h6>
        <article class="card">
            <div class="card-body row no-gutters">
                <div class="col">
                    <strong>Refund Requested:</strong> <br>16:40, 12 nov 2018
                </div>
                <div class="col">
                    <strong>Shipping company:</strong> <br> Fedex, | <i class="fa fa-phone"></i> +123467890
                </div>
                <div class="col">
                    <strong>Status:</strong> <br> Dropped In Pickup Point
                </div>
                <div class="col">
        ...
        <div class="tracking-wrap">
            <div class="step active">
                ...
                <span class="text">Refund Started</span>
            </div> <!-- step.// -->
            <div class="step active">
                <span class="icon"> <i class="fa fa-user"></i> </span>
                <span class="text"> Drop Off The Item</span>
            </div> <!-- step.// -->
            <div class="step">
                <span class="icon"> <i class="fa fa-truck"></i> </span>
                <span class="text"> We Got The Item </span>
            </div> <!-- step.// -->
            <div class="step">
