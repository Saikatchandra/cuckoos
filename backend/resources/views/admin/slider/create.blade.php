                ...
                <div class="card card-primary">	
                    <div class="card-header">	
                        <div class="d-flex justify-content-between align-items-center">    	
                         ...
                         <a href="{{ route('slider.index') }}" class="btn btn-light text-dark">Slider list</a>	
                        </div>	
                    </div>	
                                    ...
                                    <div class="row">	
                                        <div class="col-6">	
                                            <div class="form-group">	
                                                ...
                                                <input type="text" class="form-control" name="title" id="sliderName" placeholder="Enter name" value="{{ old('title') }}">	
                                            </div>	
                                        <!--     <div class="form-group"> 
                                                <label for="sliderName">Slider Slug</label> 
                                                <input type="text" class="form-control" name="slug" id="sliderName" placeholder="Enter slug" value="{{ old('slug') }}"> 
                                            </div>   -->
                                            <div class="form-group">	
